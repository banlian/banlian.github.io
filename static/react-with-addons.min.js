...
! function(e) {
	...
	return function e(t, n, r) {
		...
		8: [function(e, t) {
			...
			function c(e, t) {
				T = e, w = t, _ = e.value, T.attachEvent("onpropertychange", p)
			}

			function l() {
				T && (T.detachEvent("onpropertychange", p), T = null, w = null, _ = null, S = null)
			}

			function p(e) {
				if("value" === e.propertyName) {
					var t = e.srcElement.getAttribute("data-ie8_value");
					t !== _ && (_ = t);
						...
						for(t in l)
							if(l.hasOwnProperty(t)) {
								...
								for(p = 0; p < y.length; ++p) {
									var g = y[p];
									(g.hasAttribute && g.hasAttribute(c) || "undefined" != typeof g[c]) && (m = +g.getAttribute(c), g.removeAttribute(c), s(!d.hasOwnProperty(m)), d[m] = g, f += 1)
								}
							}
			...
			var n = e("./CSSPropertyOperations"),
				...
				p = {
					updatePropertyByID: a.measure("ReactDOMIDOperations", "updatePropertyByID", function(e, t, n) {
						var r = i.getNode(e);
						s(!l.hasOwnProperty(t)), null != n ? (c.canUseDOM && window.attachEvent && "value" === t && ("INPUT" === r.tagName || "TEXTAREA" === r.tagName) && o.setValueForProperty(r, "data-ie8_value", n), o.setValueForProperty(r, t, n)) : o.deleteValueForProperty(r, t)
					}),
		...
		49: [function(e, t) {
			...
			function r(e, t, n, r, o) {
				var i = document,
					a = i.createStyleSheet();
				for(o = i.all, t = [], e = e.replace(/\[for\b/gi, "[htmlFor").split(","), n = e.length; n--;) {
					for(a.addRule(e[n], "k:v"), r = o.length; r--;) o[r].currentStyle.k, t.push(o[r]);
					a.removeRule(0)
				}
				return t
			}
			var o = e("./AutoFocusMixin"),
				...
				f = e("./Object.assign"),
				h = e("./invariant"),
				m = c.createFactory(l.input.type),
				v = {},
				y = u.createClass({
		...
		149: [function(e, t) {
			...
			if(n.canUseDOM) {
				...
				a.innerHTML = " ", "" === a.innerHTML && (i = function(e, t) {
					if(e.parentNode && e.parentNode.replaceChild(e, e), r.test(t) || "<" === t.charAt(0) && o.test(t)) {
						e.innerHTML = "" + t;
						var n = e.firstChild;
